...
class Omada:
	...
	##
	def __init__(self, config='omada.cfg', baseurl=None, site='Default', verify=False, warnings=True, verbose=False):
		...
		if baseurl is not None:
			...
			try:
				...
				self.verify   = self.config['omada'].getboolean('verify', False)
	...
	def get_omadacId(self):
		...
		return f"/{result['result']['omadacId']}"
